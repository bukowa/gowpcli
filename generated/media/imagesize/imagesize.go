...
// ImageSize //Lists image sizes registered with WordPress.
type ImageSize struct {
    Fields string // [--fields=<fields>]
    Format string // [--format=<format>]
}

func (i ImageSize) Args() []string {
    var args = []string{"media", "image-size"}
    args = utils.MakeArg(args, "[--fields=<fields>]", i.Fields)
