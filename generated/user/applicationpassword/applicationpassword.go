...
// ApplicationPassword //Creates, updates, deletes, lists and retrieves application passwords.
type ApplicationPassword struct {
}

func (a ApplicationPassword) Args() []string {
    var args = []string{"user", "application-password"}
    return args
}
